...
const translations = {
  nl: {
    ...
    faq_a8: "OsmAnd stond waarschijnlijk nog open op de achtergrond.<br/><br/><strong>Zo los je dit op:</strong><br/>1. Sluit OsmAnd helemaal af (veeg OsmAnd weg uit het scherm met recente apps).<br/>2. Open BromBrom Manager &rarr; tik op <strong>Hulp & Probleemoplossing</strong> &rarr; <strong>\"BromBrom opnieuw installeren in OsmAnd\"</strong>.<br/>3. Tik na het downloaden op <strong>OPEN OSMAND</strong>.<br/>4. In OsmAnd: vink <strong>Instellingen</strong> en <strong>Bronnen</strong> aan &rarr; tik op <strong>Doorgaan</strong> &rarr; kies <strong>Alles vervangen</strong>.",
    faq_q3: "Ik zie het <strong>BromBrom-profiel</strong> niet in OsmAnd staan. Waar vind ik het?",
    faq_a3: "Het profiel staat meestal nog verborgen:<br/><br/>1. In OsmAnd: open het menu (<strong>drie streepjes ☰</strong>) &rarr; <strong>Instellingen</strong> &rarr; <strong>Profielen configureren</strong>.<br/>2. Zoek <strong>BromBrom</strong> (oranje autootje) en zet de schakelaar op <strong>AAN</strong> (oranje). Zet overige profielen op <strong>UIT</strong>.<br/>3. Staat BromBrom er niet tussen? Open BromBrom Manager &rarr; tik op <strong>Hulp & Probleemoplossing</strong> &rarr; <strong>\"BromBrom opnieuw installeren in OsmAnd\"</strong>.",
    faq_q2: "Ik zie een <strong>grijs raster</strong> (leeg scherm) of de <strong>routeberekening mislukt</strong>. Wat is er mis?",
    faq_a2: "OsmAnd mist de basiskaart van Nederland om wegen te kunnen tonen en routes te berekenen.<br/><br/><strong>Kaart gratis downloaden in OsmAnd:</strong><br/>1. Open het menu (<strong>drie streepjes ☰</strong>) &rarr; <strong>Kaarten en hulpmiddelen</strong>.<br/>2. Tik op <strong>Europa</strong> &rarr; <strong>Nederland</strong> &rarr; download de <strong>Standaardkaart</strong>.<br/><br/><em>Zodra de download klaar is, verschijnen alle wegen en werkt routeberekening direct.</em>",
    faq_q4: "Help, de navigatie stuurt me alsnog de <strong>snelweg</strong> of <strong>autoweg</strong> op!",
    faq_a4: "Het gewone autoprofiel staat actief in plaats van het BromBrom-profiel.<br/><br/><strong>Oplossing:</strong><br/>1. Tik bovenin het OsmAnd-navigatiescherm op het auto-icoontje.<br/>2. Kies het <strong>BromBrom-profiel</strong> (het <strong>oranje autootje van de zijkant gezien</strong>).<br/><br/><em>Met BromBrom actief worden snelwegen, autowegen en C9-verbodswegen altijd automatisch vermeden.</em>",
    faq_q10: "Hoe kan ik <strong>drukke wegen vermijden</strong> en voor <strong>rustige binnenroutes</strong> kiezen?",
    faq_a10: "1. Start een route met het <strong>BromBrom-profiel</strong> actief.<br/>2. Tik op <strong>Opties</strong> (tandwieltje) &rarr; <strong>Routeparameters</strong>.<br/>3. Vink <strong>\"Drukke wegen vermijden\"</strong> aan.<br/><br/><em>OsmAnd herberekent de route meteen langs rustige binnenwegen en dijken.</em>",
    faq_q11: "Hoe zet ik gesproken meldingen voor <strong>verkeersdrempels of zebrapaden</strong> aan of uit?",
    faq_a11: "1. In OsmAnd: open het menu (<strong>drie streepjes ☰</strong>) &rarr; <strong>Instellingen</strong> &rarr; kies <strong>BromBrom</strong>.<br/>2. Tik op <strong>Navigatie-instellingen</strong> &rarr; <strong>Gesproken instructies</strong>.<br/>3. Onder het kopje <strong>Meld</strong>: schakel <strong>Verkeerswaarschuwingen</strong> (drempels) of <strong>Zebrapaden</strong> uit of aan.",
    faq_q5: "Werkt de app ook op een <strong>iPhone</strong> (Apple iOS)?",
    faq_a5: "De automatische BromBrom Manager-app is er <strong>alleen voor Android</strong>. Op iOS installeer je de kaarten handmatig:<br/><br/>1. Download <strong>BromBrom.osf</strong> onderaan deze pagina.<br/>2. Open het bestand op je iPhone met de gratis OsmAnd-app.<br/>3. Zie de <a href=\"https://github.com/tbulligan/brombrom/blob/main/docs/manual_install.nl.md\" target=\"_blank\" class=\"link-subtle\" style=\"text-decoration: underline;\">handleiding voor iPhone (iOS)</a> met stap-voor-stap uitleg.<br/><br/><em>Let op:</em> Navigatie op het telefoonscherm is gratis. Voor <strong>Apple CarPlay</strong> op het dashboard vraagt OsmAnd een betaalde licentie (<strong>Maps+</strong> is ruim voldoende; het duurdere <strong>Pro</strong> is niet nodig).",
    faq_q12: "Heb ik een <strong>betaalde OsmAnd-licentie</strong> nodig voor <strong>Android Auto</strong>?",
    faq_a12: "Op het <strong>telefoonscherm</strong> is navigatie met OsmAnd <strong>volledig gratis</strong>.<br/><br/>Alleen voor projectie op het dashboardscherm via <strong>Android Auto</strong> vraagt OsmAnd een licentie:<br/>• <strong>Maps+</strong> (jaarlijks of eenmalig): <em>Ruim voldoende</em> voor Android Auto en onbeperkte kaarten.<br/>• <strong>Pro</strong>: Bevat extra functies (zoals satellietbeelden en reliëf), maar is <strong>niet nodig</strong> voor BromBrom.<br/><br/><em>Tip:</em> OsmAnd biedt in de Play Store regelmatig flinke seizoenskortingen aan.<br/><em>Disclaimer:</em> BromBrom is een onafhankelijk project en verdient niets aan OsmAnd.",
    faq_q9: "Is BromBrom <strong>gratis</strong>? Mag ik de app <strong>commercieel</strong> gebruiken?",
    faq_a9: "BromBrom is <strong>100% gratis voor persoonlijk gebruik</strong>.<br/><br/>Voor <strong>commercieel gebruik</strong> (zoals in een verhuurbedrijf, garage, rijschool of bezorgdienst) of herdistributie is vooraf schriftelijke toestemming nodig. Neem hiervoor <a href=\"#\" id=\"open-contact-btn\" class=\"link-subtle js-open-contact\" style=\"text-decoration: underline;\">contact met mij op</a>.",
    faq_q6: "Is de app ook geschikt voor een <strong>scootmobiel</strong> of <strong>Canta</strong>?",
    faq_a6: "<strong>Nee.</strong> BromBrom is uitsluitend gemaakt voor 45 km/u brommobielen (zoals Ligier, Aixam, Microcar).<br/><br/>Brommobielen moeten volgens de wet op de autorijbaan rijden. Scootmobielen en Cantas (gehandicaptenvoertuigen) mogen juist over het fietspad en het trottoir rijden. Gebruik BromBrom daar niet voor; de routeplanner stuurt je dan over de autorijbaan.",
    faq_q7: "Kan ik de app ook in <strong>België</strong> of <strong>Duitsland</strong> gebruiken?",
    faq_a7: "Op dit moment <strong>niet</strong>. BromBrom is specifiek ontwikkeld voor de Nederlandse wetgeving en weginfrastructuur (met officiële NDW-data voor Nederlandse C9-borden). Buiten Nederland gelden andere regels en bebording voor 45 km/u voertuigen.",
  ...
  en: {
    ...
    faq_a8: "OsmAnd was likely still running in the background.<br/><br/><strong>How to resolve:</strong><br/>1. Completely close OsmAnd (swipe it away from recent apps).<br/>2. Open BromBrom Manager &rarr; tap <strong>Hulp & Probleemoplossing</strong> (Help) &rarr; <strong>\"BromBrom opnieuw installeren in OsmAnd\"</strong>.<br/>3. When the download finishes, tap <strong>OPEN OSMAND</strong>.<br/>4. In OsmAnd: check both <strong>Settings</strong> and <strong>Resources</strong> &rarr; tap <strong>Continue</strong> &rarr; choose <strong>Replace all</strong>.",
    faq_q3: "I can't find the <strong>BromBrom profile</strong> in OsmAnd. Where is it?",
    faq_a3: "The profile is usually just hidden:<br/><br/>1. In OsmAnd: open the menu (<strong>three lines ☰</strong>) &rarr; <strong>Settings</strong> &rarr; <strong>Configure profiles</strong>.<br/>2. Find <strong>BromBrom</strong> (orange microcar icon) and switch it to <strong>ON</strong> (orange). Set other profiles to <strong>OFF</strong>.<br/>3. Not in the list at all? Open BromBrom Manager &rarr; tap <strong>Hulp & Probleemoplossing</strong> (Help) &rarr; <strong>\"BromBrom opnieuw installeren in OsmAnd\"</strong>.",
    faq_q2: "I only see a <strong>grey grid</strong> (empty screen) or <strong>route calculation fails</strong>. What is wrong?",
    faq_a2: "OsmAnd is missing the offline base map of the Netherlands.<br/><br/><strong>How to download the free map in OsmAnd:</strong><br/>1. Open the menu (<strong>three lines ☰</strong>) &rarr; <strong>Maps & Resources</strong>.<br/>2. Tap <strong>Europe</strong> &rarr; <strong>Netherlands</strong> &rarr; download the <strong>Standard map</strong>.<br/><br/><em>Once downloaded, roads appear and route calculation works immediately.</em>",
    faq_q4: "Help, the navigation is sending me onto <strong>motorways</strong> or <strong>expressways</strong>!",
    faq_a4: "The standard car profile is active instead of the BromBrom profile.<br/><br/><strong>Fix:</strong><br/>1. Tap the vehicle icon at the top of the OsmAnd navigation screen.<br/>2. Select the <strong>BromBrom profile</strong> (the <strong>orange microcar seen from the side</strong>).<br/><br/><em>With BromBrom selected, motorways, expressways, and C9-restricted roads are always avoided automatically.</em>",
    faq_q10: "How can I <strong>avoid busy roads</strong> and choose <strong>quiet scenic routes</strong>?",
    faq_a10: "1. Start a route with the <strong>BromBrom profile</strong> active.<br/>2. Tap <strong>Options</strong> (gear icon) &rarr; <strong>Route parameters</strong>.<br/>3. Check <strong>\"Avoid busy roads\"</strong> (<em>Drukke wegen vermijden</em>).<br/><br/><em>OsmAnd will recalculate to favor calm secondary and rural roads.</em>",
    faq_q11: "How do I turn voice alerts for <strong>speed bumps or pedestrian crossings</strong> on or off?",
    faq_a11: "1. In OsmAnd: open menu (<strong>three lines ☰</strong>) &rarr; <strong>Settings</strong> &rarr; select <strong>BromBrom</strong>.<br/>2. Tap <strong>Navigation settings</strong> &rarr; <strong>Voice prompts</strong>.<br/>3. Under <strong>Report</strong>: toggle <strong>Traffic warnings</strong> (speed bumps) or <strong>Pedestrian crosswalks</strong> on or off.",
    faq_q5: "Does the app work on an <strong>iPhone</strong> (Apple iOS)?",
    faq_a5: "The BromBrom Manager app is <strong>Android-only</strong>. On iOS, you install maps manually:<br/><br/>1. Download <strong>BromBrom.osf</strong> at the bottom of this page.<br/>2. Open the file on your iPhone with the free OsmAnd app.<br/>3. See the <a href=\"https://github.com/tbulligan/brombrom/blob/main/docs/manual_install.md\" target=\"_blank\" class=\"link-subtle\" style=\"text-decoration: underline;\">iPhone (iOS) guide</a> for step-by-step instructions.<br/><br/><em>Note:</em> Screen navigation is free. Displaying on your dashboard via <strong>Apple CarPlay</strong> requires an OsmAnd license (<strong>Maps+</strong> is fully sufficient; <strong>Pro</strong> is not needed).",
    faq_q12: "Do I need a <strong>paid OsmAnd subscription</strong> for <strong>Android Auto</strong>?",
    faq_a12: "On your <strong>phone screen</strong>, OsmAnd navigation is <strong>completely free</strong>.<br/><br/>A paid license is only required to display navigation on your car dashboard via <strong>Android Auto</strong>:<br/>• <strong>Maps+</strong> (annual or one-time): <em>Fully sufficient</em> for Android Auto and unlimited maps.<br/>• <strong>Pro</strong>: Adds extras (satellite imagery, elevation), but is <strong>not needed</strong> for BromBrom.<br/><br/><em>Tip:</em> OsmAnd frequently runs seasonal sales in the Google Play Store.<br/><em>Disclaimer:</em> BromBrom is an independent open-source project and receives no money from OsmAnd.",
    faq_q9: "Is BromBrom <strong>free</strong>? Can I use it <strong>commercially</strong>?",
    faq_a9: "BromBrom is <strong>100% free for personal use</strong>.<br/><br/>For <strong>commercial use</strong> (microcar rental, dealerships, driving schools, fleet operations) or redistribution, prior written permission is required. Please <a href=\"#\" id=\"open-contact-btn\" class=\"link-subtle js-open-contact\" style=\"text-decoration: underline;\">contact me directly</a>.",
    faq_q6: "Is the app suitable for <strong>mobility scooters</strong>, <strong>Cantas</strong>, or <strong>invalid carriages</strong>?",
    faq_a6: "<strong>No.</strong> BromBrom is built exclusively for 45 km/h microcars (such as Ligier, Aixam, Microcar).<br/><br/>Microcars must legally drive on the main roadway. Mobility scooters and Cantas (invalid carriages) are permitted on cycle paths and sidewalks. Do not use BromBrom for them; it will route you onto vehicle roadways.",
    faq_q7: "Can I use the app in <strong>Belgium</strong> or <strong>Germany</strong>?",
    faq_a7: "Currently, <strong>no</strong>. BromBrom is specifically built for Dutch traffic laws and road networks (using official NDW sign data for Dutch C9 signs). Foreign signs and microcar regulations are not supported.",
