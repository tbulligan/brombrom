...
const translations = {
  ...
  en: {
    ...
    faq_a10: "<ol><li>Start a route with the <strong>BromBrom profile</strong> active.</li><li>Tap <strong>Options</strong> (gear icon) &rarr; <strong>Route parameters</strong>.</li><li>Check <strong>\"Avoid busy roads\"</strong>.</li></ol><div class=\"faq-note\">OsmAnd will recalculate to favor calm secondary and rural roads.</div>",
