...
const translations = {
  ...
  en: {
    ...
    faq_a1: "This means the email address logged into your Google Play Store does not match the one registered in my testing system. Google will display an error.<br/><br/><strong>The solution:</strong> Open the <strong>Google Play Store</strong> on your phone and tap your profile picture or initial in the top right. Send me that exact email address via direct message, and I'll add your account to the test list!<br/><br/><em>Note:</em> Do you have multiple Google accounts logged into your phone? Make sure to switch to the correct registered account in the Play Store app before clicking the invite link.",
