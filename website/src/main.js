...
const translations = {
  nl: {
    ...
    faq_a10: "BromBrom heeft een ingebouwde optie om drukke wegen en verkeersaders te vermijden en de voorkeur te geven aan rustige binnen- en dijkwegen.<br/><br/><strong>Zo zet je dit aan in OsmAnd:</strong><br/>1. Start een routeplanning in OsmAnd met het <strong>BromBrom-profiel</strong> geselecteerd.<br/>2. Tik op <strong>Opties</strong> (of het tandwiel-icoontje bij route-instellingen).<br/>3. Ga naar <strong>Routeparameters</strong> (of <em>Vermijd wegen...</em>).<br/>4. Zet het vinkje aan bij <strong>\"Drukke wegen vermijden\"</strong>.<br/><br/><em>OsmAnd berekent nu direct een ontspannen, rustige route langs landelijke binnenwegen en dijken.</em>",
    faq_q11: "Hoe zet ik gesproken meldingen voor <strong>verkeersdrempels of zebrapaden</strong> uit of aan?",
    faq_a11: "Vind je dat de navigatiestem te vaak waarschuwt voor drempels of oversteekplaatsen? Je past dit eenvoudig aan in OsmAnd:<br/><br/>1. Open OsmAnd en ga naar <strong>Instellingen</strong> (via het menu met drie streepjes).<br/>2. Kies <strong>BromBrom</strong> onder Gebruikersprofielen.<br/>3. Tik op <strong>Navigatie-instellingen</strong> en daarna op <strong>Gesproken instructies</strong>.<br/>4. Onder het kopje 'Meld' tik je op <strong>Verkeerswaarschuwingen</strong> of <strong>Zebrapaden</strong> om ze naar wens aan of uit te zetten.",
    faq_q5: "Werkt de app ook op een <strong>iPhone</strong> (Apple iOS)?",
    faq_a5: "Nee, op dit moment is de BromBrom Manager <strong>alleen beschikbaar voor Android-telefoons</strong>. Er is momenteel nog geen versie voor iPhones beschikbaar in de Apple App Store.<br/><br/>Voor de avonturiers is het wel mogelijk om de kaarten handmatig op iOS te installeren. Download hiervoor het <strong>BromBrom.osf</strong> bestand onderaan de homepage en open dit direct in de OsmAnd app op je iPhone.<br/><br/><em>Belangrijke opmerkingen:</em><br/>1. Bij deze handmatige methode worden kaarten <strong>niet automatisch bijgewerkt</strong>; je zult zelf de nieuwste versie moeten downloaden.<br/>2. Navigatie op het telefoonscherm is gratis. Wil je navigeren via <strong>Apple CarPlay</strong>, dan vereist OsmAnd een betaalde licentie (<strong>Maps+</strong> is ruim voldoende; <strong>Pro</strong> is niet nodig).",
    ...
    faq_a12: "Voor navigatie op je <strong>telefoonscherm</strong> is OsmAnd volledig gratis.<br/><br/>Wil je navigeren op het dashboard van je brommobiel via <strong>Android Auto</strong>? Dan vereist OsmAnd zelf een betaalde licentie:<br/>• <strong>Maps+</strong> (jaarlijks abonnement of eenmalige aankoop): <em>Ruim voldoende</em> voor Android Auto en onbeperkte kaartdownloads.<br/>• <strong>Pro</strong>: Bevat extra's zoals cloudback-up, live weer en 3D-reliëf, maar is <strong>niet nodig</strong> voor BromBrom.<br/><br/><em>Bespaartip:</em> OsmAnd biedt in de Google Play Store regelmatig aanzienlijke seizoenskortingen aan (zoals rond feestdagen en actieperiodes). Het kan lonen om daarop te wachten!",
  ...
  en: {
    ...
    faq_a10: "BromBrom includes a built-in option to avoid busy arterial traffic in favor of calm countryside and secondary roads.<br/><br/><strong>How to enable in OsmAnd:</strong><br/>1. Start a route navigation in OsmAnd with the <strong>BromBrom profile</strong> active.<br/>2. Tap <strong>Options</strong> (or gear icon in route navigation settings).<br/>3. Tap <strong>Route parameters</strong> (or <em>Avoid roads...</em>).<br/>4. Enable <strong>\"Drukke wegen vermijden\"</strong>.<br/><br/><em>OsmAnd will recalculate to prefer scenic, quiet secondary roads and dykes.</em>",
    faq_q11: "How do I turn voice alerts for <strong>speed bumps or pedestrian crossings</strong> on or off?",
    faq_a11: "Find voice alerts for speed bumps or crosswalks too frequent? You can easily customize them in OsmAnd:<br/><br/>1. Open OsmAnd and go to <strong>Settings</strong> (three lines menu).<br/>2. Select <strong>BromBrom</strong> under App profiles.<br/>3. Tap <strong>Navigation settings</strong> and then <strong>Voice prompts</strong>.<br/>4. Under 'Report', tap <strong>Traffic warnings</strong> or <strong>Pedestrian crosswalks</strong> to toggle them on or off.",
    faq_q5: "Does the app work on <strong>iPhone</strong> (Apple iOS)?",
    faq_a5: "No, the BromBrom Manager is currently **Android-only**. There is no iOS app available in the Apple App Store.<br/><br/>For advanced users, you can manually import the maps to iOS. Download the **BromBrom.osf** file at the bottom of the homepage and open it directly with OsmAnd on your iPhone.<br/><br/><em>Important notes:</em><br/>1. Manual installations <strong>do not update automatically</strong>. You will need to manually download and import the latest `BromBrom.osf` file to get updates.<br/>2. Navigating on your iPhone screen is free. If you want to use <strong>Apple CarPlay</strong> on your dashboard, OsmAnd on iOS requires a paid license (<strong>Maps+</strong> is fully sufficient; <strong>Pro</strong> is not needed).",
    ...
    faq_a12: "Navigating directly on your <strong>phone screen</strong> with OsmAnd is completely free.<br/><br/>If you want to project navigation onto your car dashboard via <strong>Android Auto</strong>, OsmAnd requires a paid license:<br/>• <strong>Maps+</strong> (annual subscription or one-time purchase): <em>Fully sufficient</em> for Android Auto and unlimited map downloads.<br/>• <strong>Pro</strong>: Adds cloud sync, live weather, and 3D terrain, which are <strong>not needed</strong> for BromBrom.<br/><br/><em>Money-saving tip:</em> OsmAnd frequently runs substantial seasonal sales and promotions in the Google Play Store (e.g. holidays and sales events). Keep an eye out for discounts!",
