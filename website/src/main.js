...
const translations = {
  nl: {
    ...
    feat_4_desc: "Schakel optioneel 'Drukke wegen vermijden' in om provinciale verkeersaders te omzeilen en ontspannen over landelijke polderwegen te toeren.",
    ...
    faq_q10: "Hoe kan ik <strong>drukke wegen vermijden</strong> en voor <strong>rustige polderroutes</strong> kiezen?",
    faq_a10: "BromBrom heeft een ingebouwde optie om drukke provinciale wegen te vermijden en de voorkeur te geven aan rustige parallel- en polderwegen.<br/><br/><strong>Zo zet je dit aan in OsmAnd:</strong><br/>1. Start een routeplanning in OsmAnd met het <strong>BromBrom-profiel</strong> geselecteerd.<br/>2. Tik op <strong>Opties</strong> (of het tandwiel-icoontje bij route-instellingen).<br/>3. Ga naar <strong>Routeparameters</strong> (of <em>Vermijd wegen...</em>).<br/>4. Zet het vinkje aan bij <strong>\"Drukke en provinciale wegen vermijden\"</strong>.<br/><br/><em>OsmAnd berekent nu direct een ontspannen, rustige route langs landelijke binnenwegen en dijken.</em>",
    ...
    comparison_desc: "Zie het verschil: standaard autonavigatie stuurt je over verboden snelwegen zoals de A7 (links), terwijl BromBrom je over veilige en legale parallelwegen leidt (midden), of over rustige polderroutes met de optie 'Drukke wegen vermijden' (rechts).",
    label_car: "Auto (Niet toegestaan)",
    label_brombrom: "BromBrom (Legaal)",
  ...
  en: {
    ...
    feat_4_desc: "Optionally enable 'Avoid busy roads' to bypass fast provincial traffic and enjoy relaxed cruising along calm country lanes.",
    ...
    faq_a10: "BromBrom includes a built-in option to avoid busy provincial traffic in favor of calm parallel and polder routes.<br/><br/><strong>How to enable in OsmAnd:</strong><br/>1. Start a route navigation in OsmAnd with the <strong>BromBrom profile</strong> active.<br/>2. Tap <strong>Options</strong> (or gear icon in route navigation settings).<br/>3. Tap <strong>Route parameters</strong> (or <em>Avoid roads...</em>).<br/>4. Enable <strong>\"Drukke en provinciale wegen vermijden\"</strong>.<br/><br/><em>OsmAnd will recalculate to prefer scenic, quiet secondary roads and dykes.</em>",
