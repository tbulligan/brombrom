...
const translations = {
  nl: {
    ...
    step_2_desc: "Open de APK om te installeren.",
    step_3_title: "Eén-klik Update",
    step_3_desc: "Open BromBrom Manager en tik op <strong>INSTALLEREN / BIJWERKEN</strong>. OsmAnd wordt automatisch voor u ingesteld!",
    tip_title: "iOS / Apple Gebruikers",
    tip_desc: "Voor iPhone en Apple-gebruikers is er geen app nodig! Download simpelweg het BromBrom.osf pakket en open het in OsmAnd.",
  ...
  en: {
    ...
    step_3_desc: "Open BromBrom Manager and tap <strong>INSTALL / UPDATE</strong>. The app natively configures all rules inside OsmAnd for you!",
    tip_title: "iOS / Apple Users",
    tip_desc: "iPhone users do not need the manager app. Just download the pure BromBrom.osf smart-package and tap to install into OsmAnd!",
    tip_btn: "Download BromBrom.osf",
    footer_copy: "&copy; 2026 BromBrom Project.",
