...
const translations = {
  nl: {
    ...
    faq_a7: "<p>Op dit moment <strong>niet</strong>. BromBrom is specifiek ontwikkeld voor de Nederlandse wetgeving en weginfrastructuur (met officiële NDW-data voor Nederlandse C9-borden). Buiten Nederland gelden andere regels en bebording voor 45 km/u voertuigen.</p>",
  ...
  en: {
    ...
    faq_a10: "<ol><li>Start a route with the <strong>BromBrom profile</strong> active.</li><li>Tap <strong>Options</strong> (gear icon) &rarr; <strong>Route parameters</strong>.</li><li>Check <strong>\"Avoid busy roads\"</strong> (<em>Drukke wegen vermijden</em>).</li></ol><div class=\"faq-note\">OsmAnd will recalculate to favor calm secondary and rural roads.</div>",
    ...
    faq_a6: "<p><strong>No.</strong> BromBrom is built exclusively for 45 km/h microcars (such as Ligier, Aixam, Microcar).</p><p>Microcars must legally drive on the main roadway. Mobility scooters and Cantas (invalid carriages) are permitted on cycle paths and sidewalks. Do not use BromBrom for them; it will route you onto vehicle roadways.</p>",
    faq_q7: "Can I use the app in <strong>Belgium</strong> or <strong>Germany</strong>?",
    faq_a7: "<p>Currently, <strong>no</strong>. BromBrom is specifically built for Dutch traffic laws and road networks (using official NDW sign data for Dutch C9 signs). Foreign signs and microcar regulations are not supported.</p>",
