...
const translations = {
  nl: {
    ...
    faq_q1: "Ik krijg de melding \"Kan app niet installeren\" (of \"Kan niet updaten\") in de Play Store. Wat moet ik doen?",
  ...
  en: {
    ...
    faq_q1: "I get a \"Can't install app\" (or \"Can't update\") error in the Play Store. What should I do?",
