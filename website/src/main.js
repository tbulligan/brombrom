...
const translations = {
  nl: {
    ...
    btn_download_android: "Meld je aan voor Close Testing (Google Play)",
    ...
    step_1_desc: "Meld je aan voor de gesloten testfase (Alpha) en download de app via Google Play.",
  ...
  en: {
    ...
    btn_download_android: "Join Closed Testing (Google Play)",
    ...
    step_1_desc: "Join the closed testing (Alpha) and download the app via Google Play.",
    ...
    faq_a5: "No, the BromBrom Manager is currently **Android-only**. There is no iOS app available in the Apple App Store.<br/><br/>For advanced users, you can manually import the maps to iOS. Download the **BromBrom.osf** file at the bottom of our homepage and open it directly with OsmAnd on your iPhone.<br/><br/><em>Important note:</em> Manual installations <strong>do not update automatically</strong>. You will need to manually download and import the latest `BromBrom.osf` file each month.",
