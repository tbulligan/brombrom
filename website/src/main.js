...
const translations = {
  nl: {
    ...
    feat_4_desc: "Schakel optioneel de '80 km/u vermijden'-optie in om drukke provinciale wegen te omzeilen en ontspannen over rustige polderwegen te toeren.",
    ...
    faq_q10: "Hoe kan ik <strong>80 km/u wegen vermijden</strong> en voor <strong>rustige polderroutes</strong> kiezen?",
    faq_a10: "BromBrom heeft een ingebouwde optie om drukke 80 km/u-wegen te vermijden en de voorkeur te geven aan rustige parallel- en polderwegen.<br/><br/><strong>Zo zet je dit aan in OsmAnd:</strong><br/>1. Start een routeplanning in OsmAnd met het <strong>BromBrom-profiel</strong> geselecteerd.<br/>2. Tik op <strong>Opties</strong> (of het tandwiel-icoontje bij route-instellingen).<br/>3. Ga naar <strong>Routeparameters</strong> (of <em>Vermijd wegen...</em>).<br/>4. Zet het vinkje aan bij <strong>\"80 km/u en drukke wegen vermijden\"</strong>.<br/><br/><em>OsmAnd berekent nu direct een ontspannen, rustige route langs secundaire wegen en dijken.</em>",
  ...
  en: {
    ...
    feat_4_desc: "Optionally toggle 'Avoid 80 km/h and busy roads' to bypass fast provincial traffic and enjoy relaxed cruising through scenic country roads.",
    ...
    faq_q10: "How can I <strong>avoid 80 km/h roads</strong> and choose <strong>quiet scenic routes</strong>?",
    faq_a10: "BromBrom includes a built-in toggle to de-prioritize busy 80 km/h provincial roads in favor of calm parallel and polder routes.<br/><br/><strong>How to enable in OsmAnd:</strong><br/>1. Start a route navigation in OsmAnd with the <strong>BromBrom profile</strong> active.<br/>2. Tap <strong>Options</strong> (or gear icon in route navigation settings).<br/>3. Tap <strong>Route parameters</strong> (or <em>Avoid roads...</em>).<br/>4. Enable <strong>\"80 km/u en drukke wegen vermijden\"</strong>.<br/><br/><em>OsmAnd will recalculate to prefer scenic, quiet secondary roads and dykes.</em>",
