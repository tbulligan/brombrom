...
const translations = {
  nl: {
    ...
    step_3_desc: "Open BromBrom Manager en tik op <strong>INSTALLEREN / BIJWERKEN</strong>. OsmAnd opent: tik op <em>Alle instellingen en bronnen → Doorgaan → Alles vervangen</em>. Tik na de import op <em>Instellingen</em>, schakel <strong>BromBrom</strong> in en selecteer het oranje auto-icoon als actief profiel.",
    tip_title: "iOS / Apple Gebruikers",
    tip_desc: "Geen app nodig! Download BromBrom.osf en open het in OsmAnd. Tik op <em>Alle instellingen en bronnen → Doorgaan → Toepassen</em>. Na de import: Instellingen → schakel <strong>BromBrom</strong> in → selecteer het oranje auto-icoon.",
  ...
  en: {
    ...
    step_3_desc: "Open BromBrom Manager and tap <strong>INSTALL / UPDATE</strong>. OsmAnd will open: tap <em>All Settings and Resources → Continue → Replace all</em>. After import, tap <em>Settings</em>, enable <strong>BromBrom</strong>, then tap the orange car icon to select it as your active profile.",
    tip_title: "iOS / Apple Users",
    tip_desc: "No app needed! Download BromBrom.osf and open it in OsmAnd. Tap <em>All Settings and Resources → Continue → Apply</em>. After import: Settings → enable <strong>BromBrom</strong> → tap the orange car icon.",
    tip_btn: "Download BromBrom.osf",
    footer_copy: "&copy; 2026 BromBrom Project.",
