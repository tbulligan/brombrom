...
const translations = {
  nl: {
    ...
    carousel_step_8_desc: "Schakel <strong>BromBrom</strong> in (oranje) en zet alle overige profielen <strong>UIT (grijs)</strong>. BromBrom is nu je enige actieve navigatieprofiel.",
  ...
  en: {
    ...
    feat_1_title: "C9 Avoidance",
    feat_1_desc: "Smart graph routing guarantees C9-signed corridors and restricted rural routes are completely eliminated from your paths.",
    feat_2_title: "100% Offline",
    feat_2_desc: "Runs entirely through OsmAnd. No constant internet connection needed once downloaded.",
    feat_3_title: "Weekly Updates",
    feat_3_desc: "Synchronized with official weekly OpenStreetMap & NDW traffic sign exports for up-to-date accessibility.",
    feat_4_title: "Smart Profiles",
    feat_4_desc: "Tailored specifically for microcar speeds, bridge crossability, and local traffic dynamics.",
    faq_title: "Frequently Asked Questions",
    faq_q1: "I get an error <strong>\"Can't install app\"</strong> (or \"Can't update\") in the <strong>Play Store</strong>. What should I do?",
    faq_a1: "This usually happens when an older test version (for example, directly installed from a standalone APK file from GitHub) is already present on your phone. Because security keys differ between manual APKs and the Google Play Store, Android blocks the update.<br/><br/><strong>The solution:</strong><br/>1. Uninstall the app from your phone. Make sure to uncheck any option like <strong>\"Keep app data\"</strong>.<br/>2. If the error persists: go to <strong>Settings → Apps → BromBrom Manager</strong> on your phone. Tap the three dots in the top corner and select <strong>\"Uninstall for all users\"</strong>.<br/>3. Clear the Play Store app cache/storage (Settings → Apps → Google Play Store → Storage → Clear Cache & Data).<br/>4. Restart your phone and reinstall the app via Google Play.",
    faq_q2: "I only see a <strong>blank grey grid</strong> (empty screen) or <strong>route calculation fails</strong>. What is wrong?",
    faq_a2: "BromBrom provides microcar-specific routing rules and profiles, but does not include the base map tiles. OsmAnd requires the official Netherlands offline map to render roads and calculate paths.<br/><br/><strong>The solution:</strong> Download the Netherlands map inside OsmAnd:<br/>1. Open <strong>OsmAnd</strong>.<br/>2. Open the main menu (three lines in the bottom corner).<br/>3. Tap <strong>Download Maps</strong>.<br/>4. Go to <strong>Europe / Netherlands / Standard map</strong> and download it.<br/><em>Once downloaded, the screen will show full road details and routing will work immediately.</em>",
    faq_q3: "I cannot find the <strong>BromBrom profile</strong> in OsmAnd's list.",
    faq_a3: "If the profile is missing, either the import from the BromBrom Manager was not completed, or the profile is currently disabled in settings.<br/><br/><strong>The solution:</strong><br/>1. Check if the profile is disabled: in OsmAnd, navigate to <strong>Settings</strong> → <strong>Configure profiles</strong> and make sure the toggle next to <strong>BromBrom</strong> is ON.<br/>2. If it is completely missing: open BromBrom Manager and tap <strong>\"Re-install BromBrom in OsmAnd\"</strong>. Follow the on-screen instructions carefully.<br/><br/><em>Tip:</em> Need a larger screen? Open the Visual Setup Guide on <a href=\"https://brombrom.bulligan.com/#visual-guide\" class=\"link-subtle\" style=\"text-decoration: underline;\">brombrom.bulligan.com/#visual-guide</a> on a tablet or laptop to follow along.",
    faq_q4: "Help, the navigation is sending me onto <strong>motorways</strong> or <strong>expressways</strong>!",
    faq_a4: "If this happens, the standard car profile is active instead of the BromBrom profile.<br/><br/><strong>The solution:</strong> Check the navigation screen in OsmAnd. If you see a <strong>standard car icon</strong> (front view), tap it and select the <strong>BromBrom profile</strong> (orange side-view microcar). Once active, motorways and restricted roads are completely avoided.",
    faq_q5: "Does the app work on an <strong>iPhone</strong> (Apple iOS)?",
    faq_a5: "The BromBrom Manager app is currently <strong>Android-only</strong>. However, iOS users can manually download the <strong>BromBrom.osf</strong> file directly from this website and open it in OsmAnd on iPhone.<br/><br/><em>Note:</em> Manual installations do not update automatically. You will need to re-download the latest package when updates are released.",
    faq_q6: "Is the app suitable for <strong>mobility scooters</strong>, <strong>Cantas</strong>, or other vehicles?",
    faq_a6: "<strong>No, BromBrom is strictly configured for 45 km/h microcars (brommobielen).</strong> Different road accessibility and bike path rules apply to mobility vehicles and scooters.",
    faq_q7: "Can I use the app in <strong>Belgium</strong> or <strong>Germany</strong>?",
    faq_a7: "BromBrom is exclusively calibrated for <strong>Dutch road regulations and C9 traffic sign data</strong>. Cross-border navigation is not supported.",
    faq_q8: "Nothing happens or <strong>import fails</strong> when tapping \"OPEN OSMAND\".",
    faq_a8: "This happens if OsmAnd is running in the background in a state that blocks external intents.<br/><br/><strong>The solution:</strong> Swipe OsmAnd away from your recent/background apps so it is completely closed, then return to BromBrom Manager and tap \"OPEN OSMAND\" again.",
    faq_q9: "Is BromBrom <strong>free</strong>? Can I use it <strong>commercially</strong>?",
    faq_a9: "BromBrom is free for <strong>personal, non-commercial use</strong>. Commercial use or redistribution requires written permission. Use the contact form below to get in touch.",
    contact_title: "Get in Touch",
    contact_desc: "Have a question, feedback, or a map issue to report? Send a direct message.",
    ...
    contact_opt_bug: "Report Navigation / Map Error",
    ...
    carousel_step_8_desc: "Switch <strong>BromBrom</strong> to ON (orange) and turn all other profiles <strong>OFF (grey)</strong>. BromBrom is now your sole active navigation profile.",
