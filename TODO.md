...
- [x] **Semantic Exemption Logic**: Improve `has_microcar_exemption` regex to handle complex Dutch phrasing (e.g., "m.u.v.", "uitgezonderd") while strictly preventing false negatives for other vehicle types.
