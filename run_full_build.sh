...
if ls OsmAndMapCreator/Netherlands_BromBrom.obf >/dev/null 2>&1; then
    ...
    cp Netherlands_BromBrom.osm.pbf osmand_input/
    ...
    find osmand_output/ -name "*.obf" -exec mv {} OsmAndMapCreator/Netherlands_BromBrom.obf \;
fi
