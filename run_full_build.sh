...
if ls OsmAndMapCreator/Netherlands.obf >/dev/null 2>&1; then
    ...
    cp Netherlands.osm.pbf osmand_input/
    ...
    find osmand_output/ -name "*.obf" -exec mv {} OsmAndMapCreator/Netherlands.obf \;
fi
