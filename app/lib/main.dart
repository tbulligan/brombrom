...
class _InstallerScreenState extends State<InstallerScreen> {
  ...
  final Map<String, Map<String, String>> _translations = {
    'nl': {
      ...
      'osf_tip': 'OsmAnd opent nu automatisch. Tik op "Opslaan" of "Toepassen" in OsmAnd.\n\n⚠️ NIEUWE GEBRUIKERS:\nZorg ervoor dat je na de import het BromBrom Profiel actief vinkt via de Instellingen van OsmAnd!',
      'help': 'Help',
    ...
    'en': {
      ...
      'on_disk': 'In Downloads',
      'osf_tip': 'OsmAnd will now open automatically. Tap "Save" or "Apply" inside OsmAnd.\n\n⚠️ FIRST TIME USERS:\nAfter the import completes, ensure the BromBrom profile is enabled in OsmAnd Settings!',
      'help': 'Help',
