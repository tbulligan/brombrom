const Map<String, Map<String, String>> translations = {
  'nl': {
    ...
    'osf_dialog_warning': '⚠️ Sla stap 5–8 niet over — OsmAnd activeert nieuwe profielen niet automatisch.',
  ...
  'en': {
    ...
    'osf_dialog_warning': '⚠️ Do not skip steps 5–8 — OsmAnd does not enable or activate new profiles automatically.',
    'osf_dialog_btn': 'OPEN OSMAND',
